...
채팅방 목록에서 하나를 선택하면 대화방이 열리고 대화상대의 이름으로 텍스트뷰를 바꿔주는 기능까지 구현했다. 

구조는 매칭을 누르면 매칭상대를 찾고 완료되면 채팅방이 생성되어 대화를 할 수 있게 되는것인데 매칭부분에서 막혀있다.

단순 채팅 기능은 구현이 되어있지만 매칭 후 채팅방 생성기능이 제대로 되지않으면 채팅 기능이 의미가 없기때문에 일단 프로젝트에 적용시켜두진 않았다.

<img width ="40%" src ="https://user-images.githubusercontent.com/29851772/118521276-d656c700-b775-11eb-9d67-b8e6c3f18925.gif"/>
