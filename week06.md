...
Recyclerview를 사용하여 게시판 혹은 SNS형식의 게시물을 띄워줄때 DB에 데이터가 많을 경우 모든 데이터를 한번에 가져와서 띄워주기엔 무리가 있다.
그래서 한번에 어느정도씩 끊어서 데이터를 가져오고 스크롤을 내려 가져온 데이터의 맨 마지막 부분에 도달했을 시 한번 더 데이터를 가져오는식의 코드를 찾아보았고 샘플 프로젝트에 구현해보았다.

<img src="https://user-images.githubusercontent.com/29851772/114397194-5e770900-9bd9-11eb-8e56-bf160b0dbdf6.PNG" width="200" height="400">

-> 위 그림과 같이 정해진 데이터의 갯수 만큼만 불러오고 가장 아래까지 스크롤을 내리게 되면 로딩중을 보여주는 프로그레스바를 띄워주면서 새로운 데이터를 불러온다.

<img src="https://user-images.githubusercontent.com/29851772/114397250-6f277f00-9bd9-11eb-8b3c-c2484885024c.PNG" width="200" height="400">

-> 로딩 후 새로운 데이터를 불러온 모습

이러한 방식을 사용하면 많은 양의 데이터를 불러오는 형식에서 효율적으로 사용 할 수 있다.


각자 맡은 부분에서 필요한 기능들을 알아보고 샘플 프로젝트에 실제로 구현까지 해보았으니 메인 프로젝트를 만들어서 구상한 어플리케이션의 큰 틀을 만들어놓고 각각 알아본 기능들을 참고하여 협업 해 나갈 예정이다.
